    ...
    switch (logoVariant) {
      case "INTEGAI":
        return {
          ...
          alt: "IntegAI - AI with Soul sovereign platform logo",
      ...
      case "DUAL":
        return {
          ...
          hisl: { 
            ...
            alt: "HISL - Howard Integritas Solutions Ltd company logo", 
            className: "h-8 w-auto" 
          },
          integai: { 
            src: "/assets/integai-logo.png", 
            alt: "IntegAI - AI with Soul platform badge", 
  ...
  const externalLinks = [
    {
      ...
      ariaLabel: 'Visit Michael Howard\'s LinkedIn profile',
      icon: (
    ...
    },
    {
      ...
      ariaLabel: 'Visit HISL Substack newsletter',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
    ...
    },
    {
      ...
      ariaLabel: 'Send email to michael.howard@hisl.ie',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            {logoVariant !== "INTEGAI" && (
              <div className="hidden lg:flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-full border border-yellow-500/30">
                <img 
                  ...
                  className="h-4 w-4"
                  role="img"
                  aria-describedby="integai-badge-description"
                />
                <span id="integai-badge-description" className="text-xs text-yellow-400 font-medium">IntegAI</span>
              </div>
            )}
