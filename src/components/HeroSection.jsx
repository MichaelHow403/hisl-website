...
import BannerImage from '../assets/AI_Construction_Bridge_banner.png';
...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-hisl-dark via-hisl-dark to-hisl-gray/20">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          >
            We design and deploy sovereign AI systems that run on your own infrastructure, offline-first, with 
            observability, safety, and performance built in. Our mission is to empower leaders, innovators, and
            nations with technology they can truly own and trust.
          </motion.p>
